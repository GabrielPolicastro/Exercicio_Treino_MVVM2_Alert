...
//  Correcao_MVVM(Alert)
//
//  Created by Gabriel Policastro on 03/06/22.
//
...
extension DetalheDoFilmeViewController: DetalheDoFilmeViewModelDelgate {
    func exibeAlertaDeFavoritar() {
        ...
        let simAction = UIAlertAction(title: "Sim", style: .default, handler: { alerta in
